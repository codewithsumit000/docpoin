...
.form-box { background: #fff; padding: 20px; border-radius: 10px; box-shadow: 0 3px 8px rgba(0,0,0,0.1); width: 300px; }
.form-box h2 { text-align: center; color: #0077b6; margin-bottom: 15px; }
.form-group { margin-bottom: 10px; display: flex; flex-direction: column; }
.form-group label { font-size: 13px; margin-bottom: 3px; color: #333; }
.form-group input { padding: 7px; border: 1px solid #ccc; border-radius: 5px; font-size: 13px; }
.form-group input:focus { border-color: #0077b6; outline: none; }
.error { color: red; font-size: 12px; margin-top: 3px; }
.btn { width: 100%; padding: 8px; background: #0077b6; color: #fff; border: none; border-radius: 5px; cursor: pointer; margin-top: 5px; }
.btn:hover { background: #023e8a; }
.note { text-align: center; margin-top: 8px; font-size: 12px; color: #555; }
.note a { color: #0077b6; text-decoration: none; }
